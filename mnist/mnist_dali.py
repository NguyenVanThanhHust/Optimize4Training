...
def cli_main():
    ...
    external_input_iterator_train = ExternalMNISTInputIterator(
        mnist_ds=mnist_train, batch_size=args.batch_size
    )
    external_input_iterator_val = ExternalMNISTInputIterator(
        mnist_ds=mnist_val, batch_size=args.batch_size
    )
    external_input_iterator_test = ExternalMNISTInputIterator(
        mnist_ds=mnist_test, batch_size=args.batch_size
    )
    ...
    train_loader = DALIClassificationLoader(
        pipe_train, size=len(mnist_train), auto_reset=True, last_batch_policy=False
    )
    ...
    val_loader = DALIClassificationLoader(
        pipe_val, size=len(mnist_val), auto_reset=True, last_batch_policy=False
    )
    ...
    test_loader = DALIClassificationLoader(
        pipe_test, size=len(mnist_test), auto_reset=True, last_batch_policy=False
    )
