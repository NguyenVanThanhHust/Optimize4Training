...
def get_train_loader(args, dboxes):
    args.train_annotate = os.path.join(
        args.data, "annotations_trainval2017/annotations/instances_train2017.json")
...
def get_val_dataset(args):
    ...
    val_annotate = os.path.join(args.data, "annotations_trainval2017/annotations/instances_val2017.json")
