...
def image_processing_func(
    ...
    # ask HW NVJPEG to allocate memory ahead for the biggest image
...
def create_dali_pipeline(
    data_dir, crop, size, shard_id, num_shards, dali_cpu=True, is_training=True
):
...
class data_prefetcher():
    ...
    def __init__(self, loader):
        ...
        self.std = torch.tensor([0.25 * 255, 0.25 * 255, 0.25 * 255]).cuda().view(1,3,1,1)
        self.preload()
