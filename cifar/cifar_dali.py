...
def cli_main():
    ...
    train_loader = DALIClassificationLoader(
        pipe_train, size=len(trainset), auto_reset=True, last_batch_policy=False
    )
    ...
    val_loader = DALIClassificationLoader(
        pipe_val, size=len(trainset), auto_reset=True, last_batch_policy=False
    )
    ...
    test_loader = DALIClassificationLoader(
        pipe_test, size=len(testset), auto_reset=True, last_batch_policy=False
    )
